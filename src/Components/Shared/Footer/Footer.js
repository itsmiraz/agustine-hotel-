...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-gray-900 sticky bottom-0  shadow-10xl text-base-content">
                <div>
                    <span className="footer-title">Services</span>
                    <a href='/' className="link link-hover text-gray-300">Branding</a>
                    <a href='/' className="link link-hover text-gray-300">Design</a>
                    <a href='/' className="link link-hover text-gray-300">Marketing</a>
                    <a href='/' className="link link-hover text-gray-300">Advertisement</a>
                </div>
                <div>
                    ...
                    <a href='/' className="link link-hover text-gray-300">Press kit</a>
                </div>
                <div>
